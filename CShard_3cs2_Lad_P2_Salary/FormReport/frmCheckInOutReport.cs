...
{
    public partial class frmCheckInOutReport : Form
    {
        public frmCheckInOutReport()
        {
            InitializeComponent();
        ...
        private void frmCheckInOutReport_Load(object sender, EventArgs e)
        {

            rd = new ReportDocument();
            rd.Load(@"D:\Cshart3cs2\CShard_3cs2_Lad_P2_Salary\CShard_3cs2_Lad_P2_Salary\Report\crCheckInOutReport.rpt");
            ...
            // st_name
            discreteValue.Value = MyModel.staff[1];
            fieldDefinitions = rd.DataDefinition.ParameterFields;
