        ...
        private void frmStaffReport_Load(object sender, EventArgs e)
        {
            if (stid != "")
            {
               // MessageBox.Show(stid);
                ...
                rd.Load(@"D:\Cshart3cs2\CShard_3cs2_Lad_P2_Salary\CShard_3cs2_Lad_P2_Salary\Report\crReportStaff_One.rpt");
                rd.SetDataSource(ds);
                {
                //St_ID
            ...
            {
                rd = new ReportDocument();
                rd.Load(@"D:\Cshart3cs2\CShard_3cs2_Lad_P2_Salary\CShard_3cs2_Lad_P2_Salary\Report\crStaffReport.rpt");
